...
// caps.json). Gia obtains a reservation PER ACTION before it engages a target; the
// counter increments (reserved++) BEFORE the action via the herald_rate_reserve
