...
// per SEC-3). Verify the Supabase user token, then gate on the 'herald'
// capability in ecosystem_user_grants. Peer/scheduled calls carry NO JWT (IAM +
// ALLOWED_CALLERS / mode='scheduled' in the handler, SPEC-B 7.2).
